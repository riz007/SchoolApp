...
namespace StudentManagementApp.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "courseID,courseName,description,facultyID")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "courseID,courseName,description,facultyID")] Course course)
        {
            if (ModelState.IsValid)
            {
